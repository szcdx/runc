...
compile_go_fuzzer github.com/szcdx/runc/libcontainer/userns FuzzUIDMap id_map_fuzzer linux,gofuzz
compile_go_fuzzer github.com/szcdx/runc/libcontainer/user FuzzUser user_fuzzer
compile_go_fuzzer github.com/szcdx/runc/libcontainer/configs FuzzUnmarshalJSON configs_fuzzer
